...
export default {
  ...
  data() {
    return {
      visualMoment: this.initial ? mom(this.initial, 'Y-M-D') : mom(),
      originalMoment: this.initial ? mom(this.initial, 'Y-M-D') : mom(),
      selectedMoment: this.initial ? mom(this.initial, 'Y-M-D') : mom(),
      time: null,
      calendar: null,
