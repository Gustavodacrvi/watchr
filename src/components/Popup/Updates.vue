...
export default {
  components: {
    ...
    v062, v063, v064, v065, v066, v067, v068, v069, v070, v071,
  },
  created() {
  ...
  data() {
    return {
      ...
      diff: 0,
      versions: [
        '071', '070', '069', '068', '067', '066', '065', '064', '063', '062', '061', '060', '059', '058', '057', '056', '055', '054', '053', '052', '051', '050', '049', '048', '047', '046', '045', '044', '043', '042', '041', '040',
      ]
    }
  },
  methods: {
