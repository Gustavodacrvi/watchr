...
export default {
  components: {
    ...
    v073, v074, v075, v076, v077, v078, v079,
  },
  created() {
  ...
  data() {
    return {
      ...
      diff: 0,
      versions: [
        '079', '078', '077', '076', '075', '074', '073', '072', '071', '070', '069', '068', '067', '066', '065', '064', '063', '062', '061', '060', '059', '058', '057', '056', '055', '054', '053', '052', '051', '050', '049', '048', '047', '046', '045', '044', '043', '042', '041', '040',
      ]
    }
  },
  methods: {
